<?php 
add_action( 'init', 'add_submenu_clients' );

function add_submenu_clients() {
...
function cd_meta_box_cb( $client ) {
...
add_action( 'save_post', 'add_client_fields', 10, 2 );

function add_client_fields( $client_id, $client ) {
